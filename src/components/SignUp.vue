<template>
  <form class="sign-up" @submit.prevent="checkForm">
    <div class="form-group">
      ...
      <p v-if="$v.form.login.$dirty && !$v.form.login.minLength" class="invalid-feedback">Логин меньше 5 символов</p>
      </div>
    <div class="form-group">
      ...
      <p v-if="$v.form.email.$dirty && !$v.form.email.email" class="invalid-feedback">Некорректный email</p>
    </div>
    <div class="form-group">
   ...
   <div class="form-group">
     ...
     <div class="form-group">
       ...
       <select id="themes" class="form-control" multiple v-model="form.favouriteThemes">
         <option
